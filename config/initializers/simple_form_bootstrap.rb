...
SimpleForm.setup do |config|
  ...
  config.wrappers :tpn_infusion, :tag => 'div', :class => 'control-group span_custom', :error_class => 'error' do |b|
    ...
    b.wrapper :tag => 'div', :class => 'controls' do |ba|
      ba.use :input, :wrap_with => { :tag => 'div', :class => "inputy" }
      ba.use :error, :wrap_with => { :tag => 'span', :class => 'help-inline' }
      ba.use :hint,  :wrap_with => { :tag => 'p', :class => 'help-block' }
    end
  end
  
  config.wrappers :append_tpn, :tag => 'div', :class => "control-group span_custom", :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper :tag => 'div', :class => 'controls' do |input|
      input.wrapper :tag => 'div', :class => 'input-append' do |append|
        append.use :input, :wrap_with => {:tag => 'div', :class => 'inputx'}
      end
  ...
  config.wrappers :append, :tag => 'div', :class => "control-group span_custom", :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper :tag => 'div', :class => 'controls' do |input|
